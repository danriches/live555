...
OBJ =			o
LINK =			c++ -o
LINK_OPTS =		-L. $(LDFLAGS) -lssl -lcrypto
...
UNICAST_STREAMER_APPS = testRaspi$(EXE) 
...
ON_DEMAND_RTSP_SERVER_OBJS	= testRaspi.$(OBJ)
...
testRaspi$(EXE):	$(ON_DEMAND_RTSP_SERVER_OBJS) $(LOCAL_LIBS)
